// LinkGuard Firefox Extension - Content Script
class LinkGuardFirefoxContent {
  constructor() {
...
// Initialize content script for Firefox
const linkGuardFirefoxContent = new LinkGuardFirefoxContent();

// Cleanup on page unload
window.addEventListener('beforeunload', () => {
  linkGuardFirefoxContent.destroy();
});